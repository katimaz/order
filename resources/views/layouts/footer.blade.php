    ...
    <div class="container">
        ...
        <div class="footer-first-row row">
            <div class="col-lg-3 text-center">
                <a href="{{url('order')}}"><img src="/public/assets/img/logo-light.svg" alt="" width="88" class="mt-5 mb-5"></a>
            </div>
        ...
        <div class="footer-second-row">
            <a class="text-muted" href="http://www.katimaz.com" target="_blank">Copyright Katimaz 2018©. Made with love by Katimaz</a></span>
        </div>
    </div>
